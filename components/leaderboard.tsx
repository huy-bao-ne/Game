          ...
          {entries.slice(0, 3).map((entry, index) => {
            ...
            return (
              <motion.div
                ...
                animate={{ y: 0, opacity: 1 }}
                transition={{ delay: 0.6 + actualIndex * 0.15, type: "spring", stiffness: 100 }}
              ...
              >
                ...
                <motion.div 
                  ...
                  animate={{ 
                    y: [0, -5, 0],
                    rotate: actualIndex === 1 ? [0, 2, 0, -2, 0] : 0
                  }}
                  transition={{ 
                    duration: 2,
                    repeat: Infinity,
                ...
                >
                  ...
                  <div 
                    className={`text-2xl font-bold ${actualIndex === 1 ? 'text-yellow-300' : actualIndex === 0 ? 'text-gray-300' : 'text-yellow-600'}`}
                    style={{ 
                      fontFamily: "'Press Start 2P', monospace",
                ...
                {/* Podium base */}
                <motion.div
                  className={`relative w-36 ${heights[actualIndex]} ${podiumColors[actualIndex]} border-4 border-black rounded-t-lg shadow-xl overflow-hidden`}
                  style={{
